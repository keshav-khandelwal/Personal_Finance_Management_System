            ...
            <div className="flex gap-4 mt-2">
              ...
              >
                <Image
                  ...
                  width={30}
                  height={30}
                  //className="filter invert group-hover:brightness-200 transition-all duration-200"
                  className="rounded-full shadow-lg border-2 border-white object-cover transform transition-transform duration-300 hover:scale-105"
                />
              </a>
              <a
              ...
              >
                <Image
                  ...
                  width={30}
                  height={30}
                  //className="filter invert group-hover:brightness-10 transition-all duration-200"
                  className="rounded-full shadow-lg border-2 border-white object-cover transform transition-transform duration-300 hover:scale-105"
                />
              </a>
              <a
